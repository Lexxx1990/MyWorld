...
public class GoldencoinItem extends MipModElements.ModElement {
	@ObjectHolder("mip:goldencoin")
	public static final Item block = null;

	public GoldencoinItem(MipModElements instance) {
		super(instance, 5);
	}
