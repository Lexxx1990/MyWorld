...
public class ObsidiancoinItem extends MipModElements.ModElement {
	@ObjectHolder("mip:obsidiancoin")
	public static final Item block = null;

	public ObsidiancoinItem(MipModElements instance) {
		super(instance, 60);
	}
