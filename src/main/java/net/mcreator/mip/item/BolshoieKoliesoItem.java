...
public class BolshoieKoliesoItem extends MipModElements.ModElement {
	@ObjectHolder("mip:bolshoie_kolieso")
	public static final Item block = null;

	public BolshoieKoliesoItem(MipModElements instance) {
		super(instance, 11);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("bolshoie_kolieso");
		}
